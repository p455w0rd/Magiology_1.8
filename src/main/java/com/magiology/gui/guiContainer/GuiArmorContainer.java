...
import com.magiology.modedmcstuff.guiContainer.OnlyShiftClickSlot;
...
public class GuiArmorContainer extends Container{
	...
	public GuiArmorContainer(EntityPlayer player,ItemStack[] armorInventory){
		this.player=player;
