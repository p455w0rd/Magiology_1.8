...
public class GuiControlBockContainer extends Container{
	
	private TileEntityControlBlock tileCB;
	
	public GuiControlBockContainer(InventoryPlayer pInventory,TileEntityControlBlock tileCB){
		this.tileCB=tileCB;
		
		for(int i=0;i<4;i++)this.addSlotToContainer(new GuiControlBockContainerSlot(tileCB,i,80,8+i*18));
