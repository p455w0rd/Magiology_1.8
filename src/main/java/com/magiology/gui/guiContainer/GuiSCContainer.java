...
import com.magiology.modedmcstuff.guiContainer.CraftingGridSlot;
import com.magiology.modedmcstuff.guiContainer.FakeContainer;

@GUINeedsWorldUpdates
public class GuiSCContainer extends Container{
	...
	EntityPlayer player;
	public GuiSCContainer(EntityPlayer player,TileEntitySmartCrafter tileSC2, int side){
		tileSC=tileSC2;
		this.player=player;
