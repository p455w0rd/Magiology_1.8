...
public class MainMenuUpdateNotification{
	...
	private static Rectangle getBoundingBoxClick(boolean hasGL11Transformation){
		...
		return new Rectangle(
				...
				(int) ((FH+2)*scale));
//		return new Rectangle((int) ((4+(biggest-lenghts[2])/2+Get.Render.FR().getStringWidth("Click "))*scale),(int) (((4)*scale+FH*2)*scale),(int) ((Get.Render.FR().getStringWidth("[HERE]")+3)*scale),(int) ((FH+2)*scale));
	}
}
