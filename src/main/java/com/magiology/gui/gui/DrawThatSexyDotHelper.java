...
public class DrawThatSexyDotHelper extends Gui{
	...
	public void render(int x3,int y3){
		...
		x=x3;y=y3;
		if(!isUpdated){
			double scale=Helper.calculateRenderPos(prevScale, this.scale);
			double rotation=Helper.calculateRenderPos(prevRotation, this.rotation);
