...
public class GuiProgramContainerEditor extends GuiContainerM implements Updateable{
	...
	public void initGui(){
		...
		if(firstInit)text.setText(ProgramHolder.getCode(ProgramContainer.getId(stack)));
		firstInit=false;
	}
	...
	public void onGuiClosed(){
		...
		Util.sendMessage(new OpenProgramContainerInGui.ExitGui(slotId, data,tilePos));
		super.onGuiClosed();
	}
	@Override
