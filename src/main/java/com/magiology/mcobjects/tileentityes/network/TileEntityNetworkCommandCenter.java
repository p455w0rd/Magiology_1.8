...
public class TileEntityNetworkCommandCenter extends TileEntityNetwork implements ISidedInventory,IUpdatePlayerListBox{
	
	private SlowdownUtil optimizer=new SlowdownUtil(40);
	public ItemStack[] slots=new ItemStack[16];
	
	public TileEntityNetworkCommandCenter(){}
