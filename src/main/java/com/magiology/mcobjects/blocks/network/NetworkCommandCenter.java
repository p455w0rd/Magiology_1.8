...
public class NetworkCommandCenter extends BlockContainerMultiColision{
	
	public NetworkCommandCenter(){
		super(Material.iron);
	...
	public AxisAlignedBB getResetBoundsOptional(World world, BlockPos pos){
		TileEntityNetworkCommandCenter tile=(TileEntityNetworkCommandCenter) world.getTileEntity(pos);
	...
	public TileEntity createNewTileEntity(World var0, int var1){
		return NetworkBaseComponentHandeler.createComponent(new TileEntityNetworkCommandCenter());
	}
	@Override 
