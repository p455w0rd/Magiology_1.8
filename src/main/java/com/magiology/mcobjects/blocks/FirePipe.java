...
public class FirePipe extends BlockContainerMultiColision{
	...
	public AxisAlignedBB getResetBoundsOptional(World world, int x, int y, int z){
		TileEntityFirePipe tile=(TileEntityFirePipe)world.getTileEntity(x, y, z);
	    		...
	    		if(Helper.isItemInStack(MItems.FireHammer, player.getHeldItem())){
    				...
    				
    				{
    					...
    					for(AxisAlignedBB box:boxes){
    						if(box.expand(a, a, a).isVecInside(Helper.Vec3(xHit, yHit, zHit))){
    				...
    				}
    				{
    					...
    					for(AxisAlignedBB box:boxes){
    						if(box.expand(a, a, a).isVecInside(Helper.Vec3(xHit, yHit, zHit))){
        	    				...
        	    				tile2=world.getTileEntity(x, y, z-1);
