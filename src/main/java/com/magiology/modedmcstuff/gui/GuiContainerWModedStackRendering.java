...
public class GuiContainerWModedStackRendering extends GuiContainer{
	///////////------------------------------------------ Hey I copied GuiContainer class over here because I had to add an option for stacks to be of not to be rendered and if you are not ok with this I will remove it :) (bdw I took my time to remove as much possible that was not not necessary) -----------------------------------------------/////////////
    ...
    public GuiContainerWModedStackRendering(Container p_i1072_1_){
		super(p_i1072_1_);
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_){
    	///-- This is what I needed I hope you understand what I wanted :) --///
        ...
        drawScreen(p_73863_1_, p_73863_2_, p_73863_3_,false);
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_,boolean nothing)
    {
    	///-- and this --///
        int k;
    ...
    private void func_146977_a(Slot p_146977_1_){
        ...
        if (p_146977_1_ == this.clickedSlot && this.draggedStack != null && this.isRightMouseClick && itemstack != null){
            ...
            if (this.field_147008_s.size() == 1)return;
    ...
    private Slot getSlotAtPosition(int p_146975_1_, int p_146975_2_){
        for (int k = 0; k < this.inventorySlots.inventorySlots.size(); ++k){
            ...
            if(this.isMouseOverSlot(slot, p_146975_1_, p_146975_2_))return slot;
        }
        return null;
    }
    /**
