...
public class ItemRendererM{
	...
	public static ItemRendererM instance=new ItemRendererM(UtilM.getMC());
	
	protected static final ResourceLocation RES_MAP_BACKGROUND=new ResourceLocation("textures/map/map_background.png");
	protected static final ResourceLocation RES_UNDERWATER_OVERLAY=new ResourceLocation("textures/misc/underwater.png");
	 ...
	 */
	protected float equippedProgress;
	protected float prevEquippedProgress;
	protected final RenderManager renderManager;
	protected final RenderItem itemRenderer;
	/** The index of the currently held item (0-8, or -1 if not yet updated) */
	protected int equippedItemSlot=-1;
	public CustomRenderedItem renderer;
	
	
	
	

	public ItemRendererM(Minecraft mcIn){
		this.mc=mcIn;
	...
	public void renderItem(EntityLivingBase entityIn, ItemStack heldStack, ItemCameraTransforms.TransformType transform){
		if(heldStack!=null){
			...
			renderer.renderItem(heldStack, entityIn);
//			this.itemRenderer.renderItemModelForEntity(heldStack, entityIn, transform);
	 ...
	 */
	protected boolean isBlockTranslucent(Block blockIn){
		return blockIn!=null&&blockIn.getBlockLayer()==EnumWorldBlockLayer.TRANSLUCENT;
	}

	protected void func_178101_a(float angle, float p_178101_2_){
		GlStateManager.pushMatrix();
	...
	protected void func_178109_a(AbstractClientPlayer clientPlayer){
	...
	protected void func_178110_a(EntityPlayerSP entityplayerspIn, float partialTicks){
	...
	protected void renderRightArm(RenderPlayer renderPlayerIn){
		GlStateManager.pushMatrix();
	...
	protected void renderLeftArm(RenderPlayer renderPlayerIn){
		GlStateManager.pushMatrix();
	...
	protected void renderPlayerArms(AbstractClientPlayer clientPlayer){
	...
	protected void renderItemMap(AbstractClientPlayer clientPlayer, float p_178097_2_, float p_178097_3_, float p_178097_4_){
	...
	protected void func_178095_a(AbstractClientPlayer clientPlayer, float p_178095_2_, float p_178095_3_){
	...
	protected void func_178104_a(AbstractClientPlayer clientPlayer, float p_178104_2_){
	...
	protected void func_178098_a(float p_178098_1_, AbstractClientPlayer clientPlayer){
	...
	protected void func_178108_a(float p_178108_1_, TextureAtlasSprite p_178108_2_){
	 ...
	 */
	protected void renderWaterOverlayTexture(float p_78448_1_){
	 ...
	 * partialTickTime
	 */
	protected void renderFireInFirstPerson(float p_78442_1_){
		Tessellator tessellator=Tessellator.getInstance();
		WorldRenderer worldrenderer=tessellator.getWorldRenderer();
