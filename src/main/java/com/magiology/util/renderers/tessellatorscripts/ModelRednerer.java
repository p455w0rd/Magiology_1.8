...
public class ModelRednerer{
	...
	public ModelRednerer.State getVertexState()
	{
		...
		return new ModelRednerer.State(aint, new VertexFormat(this.vertexFormat));
	}
	...
	public void setVertexState(ModelRednerer.State state)
	{
	...
	public ModelRednerer tex(double u, double v)
	{
		if(vertexFormatElement==null)vertexFormatElement=vertexFormat.getElement(this.vertexFormatIndex);
	...
	public ModelRednerer lightmap(int p_181671_1_, int p_181671_2_)
	{
		int i = this.vertexCount * this.vertexFormat.getNextOffset() + this.vertexFormat.func_181720_d(this.vertexFormatIndex);
	...
	public ModelRednerer color(float red, float green, float blue, float alpha)
	{
		return this.color((int)(red * 255.0F), (int)(green * 255.0F), (int)(blue * 255.0F), (int)(alpha * 255.0F));
	}

	public ModelRednerer color(int red, int green, int blue, int alpha)
	{
		if(vertexFormatElement==null)vertexFormatElement=vertexFormat.getElement(this.vertexFormatIndex);
		if (this.noColor)
		{
	...
	public ModelRednerer pos(double x, double y, double z)
	{
		if(vertexFormatElement==null)vertexFormatElement=vertexFormat.getElement(this.vertexFormatIndex);
		int i = this.vertexCount * this.vertexFormat.getNextOffset() + this.vertexFormat.func_181720_d(this.vertexFormatIndex);
	...
	public ModelRednerer normal(float p_181663_1_, float p_181663_2_, float p_181663_3_)
	{
		if(vertexFormatElement==null)vertexFormatElement=vertexFormat.getElement(this.vertexFormatIndex);
		int i = this.vertexCount * this.vertexFormat.getNextOffset() + this.vertexFormat.func_181720_d(this.vertexFormatIndex);
